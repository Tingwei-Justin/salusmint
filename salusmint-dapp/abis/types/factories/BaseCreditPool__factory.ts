...
export class BaseCreditPool__factory {
  static readonly abi = _abi;
  static createInterface(): BaseCreditPoolInterface {
    return new utils.Interface(_abi) as BaseCreditPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BaseCreditPool {
    return new Contract(address, _abi, signerOrProvider) as BaseCreditPool;
  }
}
