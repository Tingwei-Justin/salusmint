...
import type {
  ...
  ReceivableFactoringPoolInterface,
} from "../ReceivableFactoringPool";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "creditExpiredDueToMaturity",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "creditLineNotInStateForDrawdown",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "drawdownFunctionUsedInsteadofDrawdownWithReceivable",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "onlyBorrowerOrEACanReduceCreditLine",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "receivableAssetMismatch",
    type: "error",
  },
  {
    inputs: [],
    name: "receivableAssetParamMismatch",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "unsupportedReceivableAsset",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum BaseCreditPool.CreditLineClosureReason",
        name: "reasonCode",
        type: "uint8",
      },
    ],
  ...
  },
  {
    ...
    name: "creditRecordStaticMapping",
    outputs: [
      {
        components: [
          {
    ...
    outputs: [
      {
        ...
        internalType: "struct BaseStructs.ReceivableInfo",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "receivableOwnershipMapping",
    outputs: [
      {
        internalType: "address",
        name: "",
...
export class ReceivableFactoringPool__factory {
  static readonly abi = _abi;
  static createInterface(): ReceivableFactoringPoolInterface {
    return new utils.Interface(_abi) as ReceivableFactoringPoolInterface;
  }
  static connect(
    address: string,
