...
export class BasePoolConfig__factory {
  ...
  static createInterface(): BasePoolConfigInterface {
    return new utils.Interface(_abi) as BasePoolConfigInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BasePoolConfig {
    return new Contract(address, _abi, signerOrProvider) as BasePoolConfig;
  }
}
