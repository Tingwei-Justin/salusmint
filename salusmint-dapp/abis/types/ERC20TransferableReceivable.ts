...
export interface TransferableReceivablePaymentEventObject {
  sender: string
  recipient: string
  amount: BigNumber
  paymentProxy: string
...
export type TransferableReceivablePaymentEvent = TypedEvent<
  [string, string, BigNumber, string, BigNumber, string, BigNumber, string],
  TransferableReceivablePaymentEventObject
>

export type TransferableReceivablePaymentEventFilter =
  TypedEventFilter<TransferableReceivablePaymentEvent>
...
export interface ERC20TransferableReceivable extends BaseContract {
  ...
  filters: {
    ...
    'TransferableReceivablePayment(address,address,uint256,address,uint256,address,uint256,bytes)'(
      sender?: null,
      recipient?: null,
      amount?: null,
      paymentProxy?: null,
      ...
      paymentId?: null,
      paymentReference?: PromiseOrValue<BytesLike> | null,
    ): TransferableReceivablePaymentEventFilter
